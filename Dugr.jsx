...
var listeGroupes = fenetreGroupes.add("dropdownlist",[110,2,200,25],["Aucun","Tous","Inverser"]);
...
var boutonGroupeDiscret = fenetreGroupes.add("checkbox",[2,25,222,46],"Utiliser le mode discret");
...
var boutonIsoler = fenetreGroupes.add("button",[2,48,222,68],"Isoler");
boutonIsoler.onClick = isolerSelection;
var boutonGroupesAucun = fenetreGroupes.add("button",[2,70,75,90],"Aucun");
boutonGroupesAucun.onClick = aucuneSelection;
var boutonGroupesTous = fenetreGroupes.add("button",[77,70,150,90],"Tous");
boutonGroupesTous.onClick =tousSelection;
var boutonGroupesInverser = fenetreGroupes.add("button",[152,70,222,90],"Inverser");
