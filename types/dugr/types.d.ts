...
declare namespace DuGR {
     ...
     * @param layer - The layer to test
     * @param groups - The list of group names. It can include custom groups, or predefined names taken from {@link DuGR.Group}.
     * @param [tag] - If you have the tag as returned by {@link DuAETag.get} or {@link DuAETag.set}, providing it here improves performance.
     * @param [and = false] - If false, the layer must be contained in at least one of the groups, otherwise in all the groups.
     * @returns true if the layer belongs to at least one of the given groups
     */
    function inGroups(layer: Layer, groups: string[], tag?: MarkerValue, and?: boolean): boolean;
    /**
     * Runs a function for each layer in the groups.
     * @param groups - The list of group names. It can include custom groups, or predefined names taken from {@link DuGR.Group}.
     * @param callback - The function to run on each layer.
     * @param [invert = false] - When true, the list of groups is a blacklist and the layer must not be contained in any one of them.
     * @param [comp = DuAEProject.getActiveComp] - The composition to update.
     * @param [notCallback] - The function to run on each layer IF it is NOT in the groups.
     * @param [and = false] - If false, runs the function on the layers contained in at least one of the groups, otherwise in all the groups.
     */
    function do(groups: string[], callback: DuGR~doCallBack, invert?: boolean, comp?: CompItem, notCallback?: DuGR~doNotCallBack, and?: boolean): void;
    /**
     * A function passed to {@link Dugr.do}.
     * @param layer - The layer on which the function operates.
     * @param returnValue - The return value of the previous iteration. Undefined during the first iteration.
     */
    type doCallBack = (layer: Layer, returnValue: any) => any;
    /**
     ...
     * @param [comp = DuAEProject.getActiveComp] - The composition to update.
     */
    function toggleVisibility(groups: string[], invert?: boolean, comp?: CompItem): void;
    /**
     ...
     * @param [comp = DuAEProject.getActiveComp] - The composition to update.
     */
    function toggleSound(groups: string[], invert?: boolean, comp?: CompItem): void;
    /**
     ...
     * @param [comp = DuAEProject.getActiveComp] - The composition to update.
     */
    function toggleSolo(groups: string[], invert?: boolean, comp?: CompItem): void;
    /**
     ...
     * @param [comp = DuAEProject.getActiveComp] - The composition to update.
     */
    function toggleLocked(groups: string[], invert?: boolean, comp?: CompItem): void;
    /**
     ...
     * @param [comp = DuAEProject.getActiveComp] - The composition to update.
     */
    function toggleShy(groups: string[], invert?: boolean, comp?: CompItem): void;
    /**
     * Toggles the collapse transformation/continuous rasterization mode of all layers in the groups.
     * @param groups - The list of group names. It can include custom groups, or predefined names taken from {@link DuGR.Group}.
     * @param [invert = false] - When true, the list of groups is a blacklist and the layer must not be contained in any one of them.
     * @param [comp = DuAEProject.getActiveComp] - The composition to update.
     * @param [allowLockedChanges = true] - If set to false, locked layers won't be changed.
     */
    function toggleCollapseTransformation(groups: string[], invert?: boolean, comp?: CompItem, allowLockedChanges?: boolean): void;
    /**
     ...
     * @param [allowLockedChanges = true] - If set to false, locked layers won't be changed.
     */
    function toggleGuide(groups: string[], invert?: boolean, comp?: CompItem, allowLockedChanges?: boolean): void;
    /**
     ...
     * @param [allowLockedChanges = true] - If set to false, locked layers won't be changed.
     */
    function toggleQuality(groups: string[], invert?: boolean, comp?: CompItem, allowLockedChanges?: boolean): void;
    /**
     ...
     * @param [allowLockedChanges = true] - If set to false, locked layers won't be changed.
     */
    function toggleEffects(groups: string[], invert?: boolean, comp?: CompItem, allowLockedChanges?: boolean): void;
    /**
     ...
     * @param [allowLockedChanges = true] - If set to false, locked layers won't be changed.
     */
    function toggleFrameBlending(groups: string[], invert?: boolean, comp?: CompItem, allowLockedChanges?: boolean): void;
    /**
     ...
     * @param [allowLockedChanges = true] - If set to false, locked layers won't be changed.
     */
    function toggleMotionBlur(groups: string[], invert?: boolean, comp?: CompItem, allowLockedChanges?: boolean): void;
    /**
     ...
     * @param [allowLockedChanges = true] - If set to false, locked layers won't be changed.
     */
    function toggleAdjustment(groups: string[], invert?: boolean, comp?: CompItem, allowLockedChanges?: boolean): void;
    /**
     ...
     * @param [allowLockedChanges = true] - If set to false, locked layers won't be changed.
     */
    function toggleThreeD(groups: string[], invert?: boolean, comp?: CompItem, allowLockedChanges?: boolean): void;
    /**
     * Selects the layers.
     * @param groups - The list of group names. It can include custom groups, or predefined names taken from {@link DuGR.Group}.
     * @param [invert = false] - When true, the list of groups is a blacklist and the layer must not be contained in any one of them.
     * @param [comp = DuAEProject.getActiveComp] - The composition to update.
     * @param [and = false] - If false, selects the layers contained in at least one of the groups, otherwise in all the groups.
     */
    function select(groups: string[], invert?: boolean, comp?: CompItem, and?: boolean): void;
    /**
     * Checks the isolation mode of the comp.
     * @param [comp = DuAEProject.getActiveComp] - The composition to check.
     * @returns The isolation mode.
     */
    function isolationMode(comp?: CompItem): DuGR.IsolationMode;
    /**
     * Activates the isolation mode.
     * @param groups - The list of group names. It can include custom groups, or predefined names taken from {@link DuGR.Group}.
     * @param [invert = false] - When true, the list of groups is a blacklist and the layer must not be contained in any one of them.
     * @param [comp = DuAEProject.getActiveComp] - The composition to isolate.
     * @param [frameMode = DuGR.WarningFrameMode.BELOW] - How the warning frame must be shown
     * @param [isolationMode = DuGR.IsolationMode.BOTH] - What needs to be hidden.
     * @param [compIsolationMode = DuGR.CompIsolationMode.HIDE] - How to hide the layers
     * @param [lockHiddenLayers = true] - whether to lock the layers being hidden.
     */
    function isolate(groups: string[], invert?: boolean, comp?: CompItem, frameMode?: DuGR.WarningFrameMode, isolationMode?: DuGR.IsolationMode, compIsolationMode?: DuGR.CompIsolationMode, lockHiddenLayers?: boolean): void;
    /**
     * Exits the isolation mode.
     * @param [comp = DuAEProject.getActiveComp] - The composition to update.
     */
    function exitIsolation(comp?: CompItem): void;
    /**
     * Adds the selected layers to a (new) group
     * @param group - The group name
     * @param [comp = DuAEProject.getActiveComp] - The composition to update.
     */
    function addSelectedLayersToGroup(group: string, comp?: CompItem): void;
    /**
     * Gets the list of all groups
     * @param [comp = DuAEProject.getActiveComp] - The composition to read.
     * @param [selectedLayers = false] - When true, only from selected layers.
     * @returns The list of groups
     */
    function listGroups(comp?: CompItem, selectedLayers?: boolean): DuList;
    /**
     ...
     * @param [comp = DuAEProject.getActiveComp] - The composition to read.
     */
    function renameGroup(previousName: string, newName: string, comp?: CompItem): void;
    /**
     ...
     * @param [selectedLayers = false] - When true, only from selected layers.
     */
    function removeGroup(group: string, comp?: CompItem, selectedLayers?: boolean): void;
}
